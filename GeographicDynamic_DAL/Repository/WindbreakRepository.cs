...
namespace GeographicDynamic_DAL.Repository
{
    public class WindbreakRepository : IWindbreak
    {
        ...
        //                        //File.Move(f6.FullName, newPhotoNamePath); // თუ გადანომვრა მონიშნულია ფოტოებს რაღატო ვნომრავთ ?
        //                        //აქ გადაკეთდა რომ წაიკითხოს ფოტოს არსებული სახელი და არა გადანომროს
        //                        //photoN += Convert.ToString(photocount) + "/";
        //                        photoN += Path.GetFileNameWithoutExtension(f6.FullName) + "/";
        ...
        //                                using (Image myImage = Image.FromFile(@f6.FullName))
        //                                {
        //                                    PropertyItem propItem = myImage.GetPropertyItem(306);
        //                                    string sdate = Encoding.UTF8.GetString(propItem.Value).Trim();
        //                                    string secondhalf = sdate.Substring(sdate.IndexOf(" "), (sdate.Length - sdate.IndexOf(" ")));
...

        {
            ...
            //var createResultFolder = _windbreakMethods.copyOldExcelOriginal(excelReadDTO);
            ...
            var QarsafariGadanomrvaResult = _windbreakMethods.QarsafariGadanomrva(excelReadDTO.UnicIDStartNumber, excelReadDTO.GadanomriliaUNIQID);
            ...
            if (copyOriginalExcelResult.Success == false)
            {
                return new Result<bool>
                {
                    Success = false,
                    StatusCode = System.Net.HttpStatusCode.BadGateway,
                    Message = copyOriginalExcelResult.Message,
                };
            }
            ...
            //        Success = false,
            //        StatusCode = System.Net.HttpStatusCode.BadGateway,
            //        Message = WriteToExcelOldRootWithNewUniqId.Message
            //    };
            //}


            #region didiqarsafaris amoeqsporteba
